...
<body onload="dijitalSaat();">
    ...
    <a class="navbar-brand" href="ogretmenIndex">Okul Yönetim Sistemi</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <li class="nav-item" style="display:none;">
                <a class="nav-link disabled" href="DAO/ders/ders.jsp">Dersler</a>
            </li>
            <li class="nav-item" style="display:none;">
                <a class="nav-link disabled" href="DAO/grup/grup.jsp">Gruplar</a>
            </li>
            <li class="nav-item" style="display:none;">
                <a class="nav-link disabled" href="DAO/ogrenci/ogrenci.jsp">Öğrenci Kayıt</a>
            </li>
            <li class="nav-item" style="display:none;">
                <a class="nav-link disabled" href="DAO/ogretmen/ogretmen.jsp">Öğretmen Kayıt</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="DAO/not/not.jsp">Not Giriş</a>
            </li>
            <li class="nav-item" style="display:none;">
                <a class="nav-link disabled" href="cookie.jsp">Giriş Bilgilerini Getir</a>
            </li>
            <li class="nav-item">
